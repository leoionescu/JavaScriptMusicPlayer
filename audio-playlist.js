...
const songs = [
  {
    ...
    cover_art_url: "./media/we-are-to-answer.jpg",
    cover_art_url_online:
  ...
  },
  {
    ...
    cover_art_url: "./media/ask-the-dust.jpg",
    cover_art_url_online:
...
app.load = function () {
  ...
  app.audio.addEventListener("timeupdate", function () {
    ...
    if (app.audio.duration) {
      ...
      app.scrubber.setValue(
        Math.round((currentTime * 100) / app.audio.duration)
      );
    } else {
  ...
  document
    ...
    .addEventListener("click", app.previous);
